...
import calculator.model.divide.{divideEqualsPressed, dividePressed}
import calculator.model._
import calculator.model.expansion.{RcosPressed, RsinPressed, cosPressed, plusMinusPressed, sinPressed}
import calculator.model.subtract.subtractPressed

class multiplyEqualsPressed (calculator: Calculator) extends CalculatorState (calculator) {
