...
import calculator.model.expansion.{RcosPressed, RplusMinusPressed, RsinPressed, plusMinusPressed}
import calculator.model.multiply.{RmultiplyPressed, multiplyPressed}

class RsubtractEqualsPressed(calculator: Calculator) extends CalculatorState (calculator) {
